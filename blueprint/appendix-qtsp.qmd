...
This is documentation of the [WE BUILD: WP4 QTSP group](https://github.com/webuild-consortium/wp4-qtsp-group/blob/main/README.md).
...
This is part of the [QTSP documentation](https://github.com/webuild-consortium/wp4-qtsp-group/blob/main/README.md).
...
- [Architecture overview for QEAA in WE BUILD](https://github.com/webuild-consortium/wp4-qtsp-group/blob/main/docs/qeaa/architecture.md)
...
- [QEAA issuance to EUDIW](https://github.com/webuild-consortium/wp4-qtsp-group/blob/main/docs/qeaa/issuance-to-eudiw.feature.md)
- [EAA validation at RP](https://github.com/webuild-consortium/wp4-qtsp-group/blob/main/docs/qeaa/validation.feature.md)
- [Verification of attributes](https://github.com/webuild-consortium/wp4-qtsp-group/blob/main/docs/qeaa/verification.feature.md)
