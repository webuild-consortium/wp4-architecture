...
The Commission Implementing Regulation [(EU) 2025/1944](https://eur-lex.europa.eu/eli/reg_impl/2025/1944/oj) applies regarding “reference standards for processes for sending and receiving data in \[QERDS\]s and as regards interoperability of those services”.
For the designated QERDS, no draft implementing act is available yet.
It is expected that WE BUILD implementation experience can contribute to the specification of this implementing act.

Key requirements from eIDAS include:
...
Key requirements from the EBW proposal Annex chapter 11 include:

- Mandatory EBW support for the QERDS.
- Conformance to minimum technical and interoperability requirements.
- Based on open, publicly available, royalty-free standards.
- Support for end-to-end encryption.
- Continuous availability, redundancy and fallback mechanisms.

In addition, users of European Digital Identity Wallets should be able to apply the QERDS through EBW providers as well (EBW Article 5(3)).
...
The AS4 standard is widely used in EU legislation and implementations such as Peppol using the [eDelivery AS4](https://ec.europa.eu/digital-building-blocks/sites/spaces/DIGITAL/pages/467110114/eDelivery) building block.
...
- taking eDelivery AS4 2.0 as a starting point for the common API between QTSPs;
